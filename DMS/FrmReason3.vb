...
Public Class FrmReason3
    ...
    Private Sub FrmReason3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DMSDataSet.DocsRemoval' table. You can move, or remove it, as needed.
        Me.LblID.Text = FrmSearch2.C1TrueDBGrid2.Columns(1).Text
    ...
    Private Sub BtnConfirm_Click(sender As Object, e As EventArgs) Handles BtnConfirm.Click
        ...
        Else
            Try
                ...
                FrmSearch2.source.RemoveCurrent()
